...
public class NaiveIndex {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            int columnIndex = Arrays.binarySearch(index.mTermArray, userInput);
            System.out.println("These documents contain that term: ");
            for (int rowIndex = 0; rowIndex < index.mIndex.length; rowIndex++) {
                if (index.mIndex[rowIndex][columnIndex] == true) {
                    System.out.print(index.mFileArray[rowIndex] + " ");
                }
            }
            System.out.println("\n");
